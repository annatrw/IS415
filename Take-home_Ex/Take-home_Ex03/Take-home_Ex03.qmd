...
[GWmodel](https://www.jstatsoft.org/article/view/v063i17)
...
ggplot(data = test_data_p,
  ...
  geom_point()
```
^ means a good fit of the model along the diagonal line
(gwr accurate prediction?)


## Comparison between OLS, GWR Model
```{r}
