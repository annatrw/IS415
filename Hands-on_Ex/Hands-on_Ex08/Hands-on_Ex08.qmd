...
* understand the data and variables have a distribution, not having 1 bar which might indicate it is a categorical variable and cannot be used 
...
* avoid variables with 0.8 and above (can be positive or negative values), indicating high correlation 
...
* outputs an lm object which is a list with coefficients of variables
* need to use residuals for later calculations 
...
lm() function is from base r
glm() generic linear regression model is a larger umbrella package
