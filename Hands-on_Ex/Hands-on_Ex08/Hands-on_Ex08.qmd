...
Using gtsummary package, model statistics are included in the report by using 
* add_glace_table() that appends them to the report table
* add_glance_source_note() that adds statistics as a table source note as shown below
```{r}
