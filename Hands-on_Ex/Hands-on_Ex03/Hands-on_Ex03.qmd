...
## Differences between Spatial\* classes and generic sp objects:
...
Creating owin object In spatstat, owin objects are used to represent polygonal region (Singapore boundary).
...
Kernal density estimation (KDE) The code chunk below computes a kernel density by using the following configurations of density() of spatstat:
...
Converting KDE outputs to grid object to be suitable for mapping
