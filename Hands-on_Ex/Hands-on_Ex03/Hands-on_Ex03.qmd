...
:::{callout-note}
Difference between Spatial classes and generic sp objects:
- the generic sp objects (spatial polygons) will only store the spatial component of the data
:::
...
In spatstat, owin objects are used to represent polygonal region (Singapore boundary).
