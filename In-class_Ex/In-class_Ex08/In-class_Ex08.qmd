...
*date field (if it is actual date) will be treated as continuous data causing trouble on spacetime cube
* good to always view the data and look what it is consisting of 
